...
const OrderDetailsRenderer: FunctionComponent<Props> = (props) => {
        return <div>
                ...
                <table className="table table-sm table-stripped">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th className="text-right">${props.order.total.toFixed(2)}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
            <div className="text-center">
                <NavLink to="/products" className="btn btn-secondary m-1">Back</NavLink>
                <button className="btn btn-primary m-1" onClick={props.submitCallback}>Submit Order</button>
            </div>
        </div>
}

export const OrderDetails = connectFunction(OrderDetailsRenderer)
